...
type BookTicker struct {
	...
	BidPrice    common.Float64 `json:"bidPrice"`
	BidQuantity common.Float64 `json:"bidQty"`
	AskPrice    common.Float64 `json:"askPrice"`
	AskQuantity common.Float64 `json:"askQty"`
}
